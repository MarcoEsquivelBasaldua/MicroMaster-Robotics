...
param.m = 3;        % ball mass
param.k = 5000;     % virtual spring elastic constant
param.b = 6;        % damping constant
param.N = 2.5;     % ratio of virtual spring elastic constant at thrust
...
function dQ = EOMSpringThrust(t,Q,param)
    % define the new thrust phase (applied at the bottom for param.thrusttime)
    dQ = zeros(2,1);
    dQ(1) = Q(2);
    dQ(2) = (-param.m*param.g - param.b*Q(2) - param.N*param.k*(Q(1) - param.r))/param.m;
end
